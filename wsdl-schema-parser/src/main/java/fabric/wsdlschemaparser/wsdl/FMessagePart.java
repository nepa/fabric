 ...
 * @author seidel
 */
public class FMessagePart extends FWSDLElement
{
  /**
   ...
   * is set
   */
  public FMessagePart(final String partName, final QName type, final boolean hasElementAttribute)
  {
   ...
   * for the unused one). The constructor will automatically
   * sets the correct type for the message part then.
   *
   * @param partName Name of the message part
   * @param elementName QName value of the 'element' attribute
   * @param typeName QName value of the 'type' attribute
   */
  public FMessagePart(final String partName, final QName elementName, final QName typeName)
  {
    this.partName = partName;
   ...
   * 
   * @return String representation of FMessagePart object
   */
  @Override
