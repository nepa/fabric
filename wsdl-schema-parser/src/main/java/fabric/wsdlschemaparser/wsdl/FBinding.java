 ...
 * @author seidel
 */
public class FBinding extends FWSDLElement
{
  /** Name of the binding */
   ...
   */
  public FBinding(final String bindingName, final QName portTypeReference)
  {
   ...
   *
   * @return String representation of FBinding object
   */
  @Override
