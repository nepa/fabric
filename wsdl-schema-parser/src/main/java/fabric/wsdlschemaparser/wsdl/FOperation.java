 ...
 * @author seidel
 */
public class FOperation extends FWSDLElement
{
   ...
   */
  public FOperation(final String operationName, final FOperationType operationType,
   ...
   * (if any).
   *
   * @return String representation of FOperation object
   */
  @Override
